    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="dist/img/y.jpg" alt="Logo" class="brand-image img-circle elevation-3">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="dist/img/anim.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item <?php if (isset($lmenu) && $lmenu == 'buku') {
                                                echo 'menu-open';
                                            } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="books.php" class="nav-link <?php if (isset($sbLmenu) && $sbLmenu == 'buku') {
                                            echo 'active';
                                        } ?>">
                        ...
                        <li class="nav-item <?php if (isset($lmenu) && $lmenu == 'transaksi') {
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="dataPengembalian.php" class="nav-link <?php if (isset($sbLmenu) && $sbLmenu == 'kembali') {
                                            echo 'active';
                                        } ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pengembalian</p>
